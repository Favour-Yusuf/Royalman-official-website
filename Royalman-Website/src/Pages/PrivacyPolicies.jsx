...
const PrivacyPolicies = () => {
  return (
    ...
    <li>
    <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Royalman Digital Concept, Abuja, Nigeria..</p>
    </li>
    <li>
    ...
    <li>
    <p><strong>Website</strong> refers to Royalman Digital Concept, accessible from <a href="https://www.royalmandigitalconcept.com/" rel="external nofollow noopener" target="_blank">https://www.royalmandigitalconcept.com/</a></p>
    </li>
    <li>
    ...
    <ul>
    <li>By email: royalmanglobalenterprise@gmail.com</li>
    </ul>
    </>
  )
}
