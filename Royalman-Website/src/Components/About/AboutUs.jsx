...
const AboutUs = () => {
  return (
    <div className="w-full h-auto flex flex-col-reverse lg:flex-row justify-between items-center bg-aboutbg bg-cover p-4 lg:p-0">
      <div className="h-[300px] lg:ml-24 w-full lg:w-[400px] mb-6 lg:mb-0 rounded-xl">
        <img
      ...
      <div className="h-auto w-full lg:mr-24 lg:w-[400px] bg-white shadow-2xl rounded-xl flex flex-col items-center justify-center p-6">
