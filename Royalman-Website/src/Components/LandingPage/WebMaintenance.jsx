...
const WebMaintenance = () => {
  return (
    <div className='h-[100vh] w-[100%] flex items-center justify-center  '>
        <div className='h-[98%] w-[90%] shadow-2xl flex flex-col items-center rounded-2xl '>
            ...
            <div className='h-[80px] w-[80%] mb-7 border-brandTwo  border-opacity-70 border-2 rounded-[40px] flex items-center justify-center text-[30px] '>N30k/Month</div>
                ...
                <button className='h-[50px] w-[300px] bg-brandOne text-[20px] rounded-xl font-bold mb-6'>Chat with us</button>
        </div>
    </div>
  )
}
