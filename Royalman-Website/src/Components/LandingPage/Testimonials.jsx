...
const Testimonials = () => {
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
        <h2 className="text-2xl sm:text-3xl font-bold text-gray-800 mb-4">Don’t Just Take Our Word for It…</h2>
      {testimonials.map((testimonial, index) => (
        <div key={index} className="bg-white shadow-lg rounded-lg p-6 mb-6">
          <h3 className="text-xl sm:text-2xl font-semibold text-gray-800 mb-2">{testimonial.name}</h3>
