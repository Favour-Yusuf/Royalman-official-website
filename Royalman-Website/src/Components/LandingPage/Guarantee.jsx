  ...
  return (
    <div className="max-w-3xl mx-auto px-6 py-12 bg-white shadow-lg rounded-lg">
      ...
      <h3 className="text-xl font-semibold text-center text-gray-800 mb-6">
        We’re Confident You’ll Love Your New Website, But If You’re Not
        Completely Satisfied…
      </h3>
      <p className="text-gray-700 text-center mb-8">
        We stand by our work and want you to feel absolutely confident in your
        decision to work with us. That's why we offer a 30-day money-back
        guarantee. If, for any reason, you’re not completely satisfied with your
        new website within 30 days of launch, let us know and we’ll refund your
